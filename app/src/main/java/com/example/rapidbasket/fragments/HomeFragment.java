package com.example.rapidbasket.fragments;
...
import com.example.rapidbasket.activities.AllProductsActivity;
import com.example.rapidbasket.adapters.CategoryAdapter;
import com.example.rapidbasket.adapters.NewProductsAdapter;
import com.example.rapidbasket.adapters.PopularProductAdapter;
import com.example.rapidbasket.models.CategoryModel;
...
public class HomeFragment extends Fragment {
    ...
    TextView catAll, popularAll;

    RecyclerView catRecyclerView, popularRecView;
...
//        newProdRecView=root.findViewById(R.id.new_product_rec);
        popularRecView = root.findViewById(R.id.popular_rec);
...
//        newProdRecView.setLayoutManager(new LinearLayoutManager(getActivity(),RecyclerView.HORIZONTAL,false));
//        newProductsModelList=new ArrayList<>();
//        newProductsAdapter=new NewProductsAdapter(getContext(),newProductsModelList);
//        newProdRecView.setAdapter(newProductsAdapter);
//
...
//        popular products
        ...
        popularRecView.setAdapter(popularProductAdapter);
