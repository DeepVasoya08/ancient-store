...
import com.example.rapidbasket.adapters.CartAdapter;
...
//        get data from cart adapter
        LocalBroadcastManager.getInstance(this).registerReceiver(broadcastReceiver,new IntentFilter("TotalBill"));

        totalBill=findViewById(R.id.cart_totalBill);
    ...
    public BroadcastReceiver broadcastReceiver=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            int total = intent.getIntExtra("total_bill",0);
            totalBill.setText("Total Amount: ₹"+total);
        }
    };
}